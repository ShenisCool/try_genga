...
void Yarkovski(double &a, const double e, double m, const double mu, const double R, const double4 spin, const double3 h3, const double h, const double dt){
...
// *****************************************************************
void Yarkovski2(double &a, const double e, double m, const double Msun, const double R, const double4 spin, const double3 h3, const double h, const double dt){
...
void CallYarkovsky_averaged_cpu(double4 *x4_h, double4 *v4_h, double4 *spin_h, int *index_h, double2 *Msun_h, double *dt_h, const double Kt, const int N, const int Nst, const int Nstart){
