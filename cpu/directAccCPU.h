#ifndef DIRECTACCCPU_H
#define DIRECTACCCPU_H
...
//
// ****************************************
void accEnc(double4 x4i, double4 x4j, double3 &ac, volatile double *rcritv_, double &test, const int i, const int j, const int NN, const double MinMass, const int UseTestParticles, const int SLevels){
...
//December 2016
// ****************************************
void accEncFull(double4 x4i, double4 x4j, double3 &ac, double &test, int i, int j, double MinMass, int UseTestParticles){
...
//
// ****************************************
inline void accEncG3(double4 x4i, double4 x4j, double3 &ac, double &test, int i, int j, double time, double K, double MinMass, int UseTestParticles){
...
//
// ****************************************
void accEncSun(double4 x4i, double3 &ac, const double ksqMsun){
...
//
// **************************************************
inline void CorrectKick(double4 x4i, double4 x4j, double3 &ac, double K, double Kold, double &test, int i, int j, double time, int NB, double MinMass, int UseTestParticles){
...
//March 2014
//*************************************************
inline void CorrectKick2(double4 x4i, double4 x4j, double3 &ac, double K, double Kold, double &test, int i, int j, double time, int E, double MinMass, int UseTestParticles){
...
//
//****************************************
void collide(int &random, volatile double4 *x4, volatile double4 *v4, const int i, const int j, const int indexi, const int indexj, const double Msun, double *U_h, double &test, int *index, const int nc, double *Coll, double time, double4 *spin, double3 *love, int *createFlag, volatile double *rcritv, double *rcrit_h, const int NN, const int NconstT, float4 *aelimits, unsigned int *aecount, unsigned int *enccount, unsigned long long *aecountT, unsigned long long *enccountT, const int SLevels, const int noColl){
...
//printf("collide %d %d %g CollisionModel: %d\n", (index[indexi]), (index[indexj]), time, CollisionModel_c[0]);
	...
	if(noColl == 0){
		*U_h += 0.5 * mimj / mtot * vsq - mimj * def_ksq / sqrt(rsq);
	}
	...
	for(int l = 0; l < SLevels; ++l){
		...
		rcrit_h[indexi + l * NconstT] = fmax(rcrit_h[indexi + l * NconstT], rcrit_h[indexj + l * NconstT]);
		rcrit_h[indexj + l * NconstT] = 0.0;
	}
...
//
//****************************************
void storeEncounters(volatile double4 *x4, volatile double4 *v4, int i, int j, int indexi, int indexj, int *index, int nc, double *Coll, double time, double4 *spin){
