...
extern double Rcut_c[1];
extern double RcutSun_c[1];
extern int StopAtCollision_c[1];
extern double StopMinMass_c[1];
extern double CollisionPrecision_c[1]; 
extern double CollTshift_c[1]; 
extern int CollisionModel_c[1];
extern int2 CollTshiftpairs_c[1]; 
extern int WriteEncounters_c[1]; 
extern double WriteEncountersRadius_c[1]; 
extern int WriteEncountersCloudSize_c[1]; 
extern int StopAtEncounter_c[1]; 
extern double StopAtEncounterRadius_c[1]; 
extern double Asteroid_eps_c[1];
extern double Asteroid_rho_c[1];
extern double Asteroid_C_c[1];
extern double Asteroid_A_c[1];
extern double Asteroid_K_c[1];
extern double Asteroid_V_c[1];
extern double Asteroid_rmin_c[1];
extern double Asteroid_rdel_c[1];
extern double SolarConstant_c[1];
extern double Qpr_c[1];
extern double SolarWind_c[1];

extern double BSddt_c[8];		//time stepping factors in Bulirsch-Stoer method
extern double BSt0_c[8 * 8];

extern double CreateParticlesParameters_c[12];
